...
import { saGetHotels, type HotelSummary } from "@/lib/superadmin-api";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold text-slate-800">All Hotels</h2>
        ...
        {/* Search */}
        <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 h-10 w-full sm:w-72 shadow-sm focus-within:ring-2 focus-within:ring-slate-200">
                    ...
                    >
                      ...
                      <td className="px-5 py-4 text-right">
                        <Link
                          ...
                          className="group inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 hover:border-slate-300 hover:text-slate-800 transition-all shadow-sm"
                        >
                          View
