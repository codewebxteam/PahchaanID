...
import { saGetVerifications, type VerificationRecord } from "@/lib/superadmin-api";
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-sm font-medium text-slate-500 mt-1">
            Real-time access logs for {verifications.length} visitor registrations across the network.
          </p>
        </div>
        <div className="flex flex-col sm:flex-row gap-3 w-full md:w-auto">
           <div className="relative flex-1 md:w-72">
             ...
             <input
                ...
                className="w-full pl-10 pr-4 h-11 rounded-xl border border-slate-200 bg-white text-sm focus:outline-none focus:border-amber-500 shadow-sm"
             />
          </div>
        </div>
      </div>
                ...
                filtered.map((v) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-5 text-right">
                       <button className="p-2 rounded-lg bg-slate-50 text-slate-400 hover:text-amber-600 hover:bg-amber-50 transition-all">
                   ...
                   <div className="px-8 py-10 space-y-10">
                      ...
                      {selectedVerification.purpose && (
                        <section className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
                           ...
                           <p className="text-sm font-bold text-slate-700 leading-relaxed italic border-l-2 border-amber-500 pl-4">
                              "{selectedVerification.purpose}"
                           </p>
                        </section>
                      )}
