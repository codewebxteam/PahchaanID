...
import { clearToken } from "@/lib/superadmin-auth";
import { cn } from "@/lib/utils";

const navItems = [
  { href: "/superadmin/dashboard", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/superadmin/hotels", icon: Building2, label: "Hotels" },
  { href: "/superadmin/owners", icon: Users, label: "Owners" },
  { href: "/superadmin/verifications", icon: ShieldCheck, label: "Verifications" },
  { href: "/superadmin/admins", icon: UserCog, label: "District Admins" },
  { href: "/superadmin/districts", icon: MapPin, label: "Districts" },
];
